...
<%ArrayList<Bean> al = new ViewDAO().routerViewNoDetection(); %>
    <section id="MainContainer">
        ...
        <section id="Register">
            <div class="container contact-container">
                <h3 class="contact-title" style="margin-top: 15%; color: blue;">PC Results</h3>
                ...
                <div class="contact-outer-wrapper">
                    ...
                    <%if(!al.isEmpty()){ %>
                        <table class="table table-bordered" style="text-align: center;">
                                    <tr>
                                        <th style="padding: 20px;">Number of Attacks Detected</th>
                                        <th style="padding: 20px;">Number of Attacks Defended</th>
                                    </tr>
                                    <%for(Bean b:al){ %>
                                    <tr>
                                ...
                                <%}else{ %>
                                	<h3 class="contact-title" style="margin-top: 5%; color: red;">Results Not Available</h3>
                                <%} %>
                    </div>
                </div>
            </div>
