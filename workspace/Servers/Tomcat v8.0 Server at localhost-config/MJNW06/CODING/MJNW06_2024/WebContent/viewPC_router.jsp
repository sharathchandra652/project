...
<%ArrayList<Bean> al = new ViewDAO().routerViewAcceptedPC(); %>
    <section id="MainContainer">
        ...
        <section id="Register">
            <div class="container contact-container">
                <h3 class="contact-title" style="margin-top: 15%; color: blue;">View PC's</h3>
                ...
                <div class="contact-outer-wrapper">
                    ...
                    <%if(!al.isEmpty()){ %>
                        <table class="table table-bordered" style="text-align: center;">
                                ...
                                <%}else{ %>
                                	<h3 class="contact-title" style="margin-top: 5%;">Accepted PC's are Not Available</h3>
                                <%} %>
                    </div>
                </div>
            </div>
